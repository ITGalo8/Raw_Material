    ...
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        <ScrollView showsVerticalScrollIndicator={true}>
          {/* <Card backgroundColor="#fbd33b" title="Total Defective" content="Bhiwani" quantity={data?.overallTotal} />
          <Card backgroundColor="#E1341E" title="Pump" content="Total Defective" quantity={data?.item?.Pump} />
          <Card backgroundColor="#97bcc7" title="Controller" content="Total Defective" quantity={data?.Controller} />
          <Card backgroundColor="#FFAEBC" title="Motor" content="Total Defective" quantity={data?.Motor} />
          <Card backgroundColor="#868b8e" title="Stock" content="Total Defective" quantity={data?.Others} /> */}
